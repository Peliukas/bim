...
@section('content')
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                            ...
                            <a href="{{ url('/admin/course-info') . '/' . $course->id }}" onClick="window.open(this.href,'pagename','resizable,height=800,width=800'); return false;">
                                <button class="btn btn-warning">Edit course info</button>
                            </a>
                            <hr>
                        <div class="col-md-12">
                            <div class="list-group">
                                ...
                                @foreach($allNews as $news)
                                    {{ $news->title }}
                                    <a href="{{ url('/admin/remove-course-news') . '/' . $news->id }}" onclick="return confirm('Are you sure?')" style="float: right;">Remove</a>
                                    <hr>
                                @endforeach
                            </div>
                        </div>
                            ...
                            <div class="list-group">
                                ...
                                @foreach($schedule as $s)
                                    <a href="#" class="list-group-item">
                                        ...
                                        <br>
                                        <i>{{$s->place}}</i>
                                        <a href="{{ url('/admin/delete-schedule') . '/' . $s->id }}" style="float: right;">Remove</a><br>
                                    </a>
                                @endforeach
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="list-group">
                                ...
                                @foreach(BIM\HomeworkFolders::where('course_id', '=', $course->id)->get() as $folder)
                                    @if($course->id == 2)
                                        <a href="{{ url('/admin/homework-folder') . '/' . $folder->id }}" class="list-group-item"  onClick="window.open(this.href,'pagename','resizable,height=800,width=800'); return false;">
                                ...
                                @foreach($homework as $hw)
                                    <a href="{{ url('/review/homework') . '/' . $hw->id }}" class="list-group-item"  onClick="window.open(this.href,'pagename','resizable,height=800,width=800'); return false;">
                                        <i class="fa fa-file" aria-hidden="true"></i>  {{ $hw->name }}
                                    </a>
                                    <a href="{{ url('/admin/delete-homework') . '/' . $hw->id }}" style="float: right">Remove</a>
                                @endforeach
                            </div>
                        ...
                        <hr>
                            <div class="col-md-6" style="padding: 15px;">
                                <div class="list-group">
                                    ...
                                    @foreach(BIM\MaterialFolders::where('course_id', '=', $course->id)->get() as $folder)
                                        @if($course->id == 2)
                                            <a href="{{ url('/admin/material-folder') . '/' . $folder->id }}" class="list-group-item"  onClick="window.open(this.href,'pagename','resizable,height=800,width=800'); return false;">
                                                <i class="fa fa-folder-open" aria-hidden="true"></i> {{ ($folder->groupNo == 1) ? $folder->name . ' (Mondays - Wednesdays)' : $folder->name . ' (Tuesdays - Thursdays)'}}
                                            </a>
                                        @endif
                                        @if($course->id == 3)
                            ...
                            {{--@if(isset($revit))--}}
                                {{--@include('admin.partials.revit')--}}
                            {{--@endif--}}
                            {{--@if(isset($inventor))--}}
                                {{--@include('admin.partials.inventor')--}}
                            {{--@endif--}}
                            {{--@if(isset($else))--}}
                                {{--@include('admin.partials.else')--}}
                            {{--@endif--}}
                                ...
                                <div class="list-group">
                                    ...
                                    @foreach($users_waiting as $w)
                                        <div  class="list-group-item" target="_blank">
                                            <a href="{{ url('/admin/view-student') . '/' . $w->student_id }}" onClick="window.open(this.href,'pagename','resizable,height=800,width=800'); return false;">
                                                {{\BIM\User::getName($w->student_id) . ' ' . \BIM\User::getSurname($w->student_id)}}
                                            </a>

                                            <a href="{{ url('/admin/approve-to-course') . '/' . $w->id }} ">
                                                <button type="button" class="btn btn-success" style="float: right;">Approve</button>
                                            </a>
                                            <a href="{{ url('/admin/reject') . '/' . $w->id }} ">
    ...
    <div class="modal fade" id="newSchedule" tabindex="-1" role="dialog" aria-labelledby="newSchedule">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/add-schedule') }}">
                    {{ csrf_field() }}
    ...
    <div class="modal fade" id="newMaterial" tabindex="-1" role="dialog" aria-labelledby="newMaterial">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/add-material') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="modal fade" id="newEnrollment" tabindex="-1" role="dialog" aria-labelledby="newEnrollemnt">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/add-enrollment') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="modal fade" id="newEmail" tabindex="-1" role="dialog" aria-labelledby="newEmail">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/send-email-course') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="modal fade" id="addNews" tabindex="-1" role="dialog" aria-labelledby="addNews">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/add-news') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="modal fade" id="createFolderHomework" tabindex="-1" role="dialog" aria-labelledby="createFolderHomework">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/create-folder-homework') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="modal fade" id="createFolderMaterial" tabindex="-1" role="dialog" aria-labelledby="createFolderMaterial">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/create-folder-material') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
