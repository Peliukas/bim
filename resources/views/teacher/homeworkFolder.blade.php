...
<div class="col-md-12 single-student-container" style="margin-top: 55px;">
    ...
    @endif
        ...
        <a href="{{ url('/teacher/remove-homework-folder') . '/' . $folder->id }}" style="float: right;" onclick="return confirm('This will delete all homework inside!')">
        ...
        @if(isset($homework))
            ...
            @foreach($homework as $h)
                    ...
                    <a href="{{ url('teacher/delete-homework') . '/' . $h->id }}" style="float: right;">Remove</a><br>
                </a>
            @endforeach
        @endif
</div>
