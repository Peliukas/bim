...
<div class="col-md-12 single-student-container">
    ...
    <br>
    <h3>Send email</h3>
    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('/teacher/send-student-email') }}">
        {{ csrf_field() }}
    ...
    @foreach($enrollments as $enrollment)
        @if(file_exists(public_path('profile' . '/' . $enrollment->student_id . '/' . \BIM\Courses::getSlug($enrollment->course_id) . '-info.json')))
            ...
            <br>
            <a href="{{ url('/teacher/view-student-course-info') . '/' . $enrollment->id }}">
