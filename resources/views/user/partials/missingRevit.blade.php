<div class="modal fade" id="missingRevitApplication" tabindex="-1" role="dialog" aria-labelledby="missingRevitApplication">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/missing-course/2') }}">
                {{ csrf_field() }}
                <div class="modal-header">
                    Revit course application
                </div>
