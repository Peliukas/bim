...
@section('content')
    <div class="panel-heading start-page-title">Register</div>
                            ...
                            <div class="form-group{{ $errors->has('studyProgram') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select id="studyProgram" name="studyProgram" class="form-control">
                                        ...
                                        <option value="Supply Engineering">Supply Engineering</option>
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('typeOfStudies') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select id="typeOfStudies" name="typeOfStudies" class="form-control">
                                        ...
                                        <option value="erasmus">Exchange student</option>
                                    </select>
